...
Verify that a organiclifed node can load multiple wallet files
"""
...
class MultiWalletTest(PivxTestFramework):
    ...
    def run_test(self):
        ...
        assert_equal(node.cli("-rpcwallet=").getwalletinfo()["walletname"], "")
        assert_equal(node.cli("-rpcwallet=w1").getwalletinfo()["walletname"], "w1")
