...
class MasternodeActivationTest(PivxTier2TestFramework):
    ...
    def set_test_params(self):
        ...
        self.include_dmn = False
        for i, args in enumerate(self.extra_args):
            filtered = [arg for arg in args if not arg.startswith("-nuparams=v6_evo:")]
            filtered.append("-nuparams=v6_evo:999999")
            self.extra_args[i] = filtered
