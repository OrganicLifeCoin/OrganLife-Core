...
By default, organiclifed will dump mempool on shutdown and
...
class MempoolPersistTest(PivxTestFramework):
    ...
    def run_test(self):
        ...
        self.log.debug("Prevent organiclifed from writing mempool.dat to disk. Verify that `savemempool` fails")
