...
This means one can have an always-on organiclifed instance running, and another local organiclifed/organiclife-qt instance which connects to this node and receives blocks from it.
