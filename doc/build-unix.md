...
BerkeleyDB is required for the wallet. If your distro doesn't provide Berkeley DB 4.8,
prefer building via `depends/` or build Berkeley DB 4.8 locally using `contrib/install_db4.sh`.
...
To build with Qt 6 you need the following (Ubuntu/Debian):

    sudo apt-get install qt6-base-dev qt6-tools-dev qt6-tools-dev-tools qt6-svg-dev qt6-charts-dev qt6-image-formats-plugins libqrencode-dev

To build with Qt 5 you need the following (Ubuntu/Debian):
...
To build with Qt 6 you need the following:
    ...
    sudo dnf install qt6-qttools-devel qt6-qtbase-devel qt6-qtsvg-devel qt6-qtcharts-devel qrencode-devel
