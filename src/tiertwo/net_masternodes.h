...
#ifndef PIVX_TIERTWO_NET_MASTERNODES_H
#define PIVX_TIERTWO_NET_MASTERNODES_H
...
public:
    ...
    bool isMasternodeQuorumNode(const CNode* pnode, const CDeterministicMNList& mnList);
...
#endif // PIVX_TIERTWO_NET_MASTERNODES_H
