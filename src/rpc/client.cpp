...
static const CRPCConvertParam vRPCConvertParams[] = {
    ...
    { "creategovvotelock", 1, "amount" },
    { "creategovvotelock", 2, "unlock_height" },
    { "creategovvotelock", 3, "return_lock_ref" },
    { "createpqproposal", 2, "payments" },
    { "createpqproposal", 3, "start" },
    { "createpqproposal", 5, "amount" },
    { "createrawmnfinalbudget", 1, "blockstart" },
    { "createrawmnfinalbudget", 2, "proposals" },
    { "castgovvote", 2, "lock_refs" },
