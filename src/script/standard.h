 ...
 *  A CTxDestination is the internal data type encoded in a OrganicLife address
 */
...
/**
 * Generate a OrganicLife scriptPubKey for the given CTxDestination. Returns a P2PKH
