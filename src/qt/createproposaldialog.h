...
#ifndef PIVX_QT_CREATEPROPOSALDIALOG_H
#define PIVX_QT_CREATEPROPOSALDIALOG_H
...
class CreateProposalDialog : public ContainerDialog
{
    Q_OBJECT
...
#endif // PIVX_QT_CREATEPROPOSALDIALOG_H
