...
public Q_SLOTS:
    ...
    void setWalletName(const QString& name, bool configured);

Q_SIGNALS:
    void reply(int category, const QString& command);

private:
    bool ExecuteCommandLine(std::string& strResult, const std::string& strCommand, const QString& walletName, bool walletNameConfigured);
    QString walletName;
    bool walletNameConfigured{false};
};
