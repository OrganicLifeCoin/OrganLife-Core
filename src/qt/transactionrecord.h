...
public:
    ...
    static bool TryExtractProposalName(const std::string& proposalHex, std::string& proposalNameOut);
    ...
    /** Stored block height for this transaction record */
    int sortBlockHeight = 0;
    CAmount debit;
    CAmount credit;
    unsigned int size;
