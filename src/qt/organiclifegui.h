...
public Q_SLOTS:
    ...
    */
    ...
    WalletModel* removeWallet(const QString& name);
    void removeAllWallets();
    QStringList getWalletNames() const;
    QString currentWalletName() const;
    WalletModel* getWallet(const QString& name) const;
    WalletModel* currentWalletModel() const;
    QString walletDisplayName(const QString& name) const;
    void setWalletDisplayName(const QString& name, const QString& displayName);
    QString primaryWalletName() const;
    bool isPrimaryWallet(const QString& name) const;
    void setPrimaryWalletName(const QString& name);
    QStringList autoloadWalletNames() const;
    void addAutoloadWalletName(const QString& walletName);
    void removeAutoloadWalletName(const QString& walletName);
    void persistAutoloadWalletNames(const QStringList& walletNames);
#endif // ENABLE_WALLET
...
private:
...
#ifdef ENABLE_WALLET
    std::map<QString, QPointer<WalletModel>> walletStack;
    QString currentWallet;
    bool walletUiSignalsConnected{false};
    QMetaObject::Connection walletMessageConnection;
    QMetaObject::Connection walletProgressConnection;

    static QString walletSettingsId(const QString& name);
    void applyWalletMetadata(const QString& name, WalletModel* walletModel);
    void refreshWalletMetadata();
#endif
    ...
    void updateContentCornerArc();
    void updateContentCornerArcStyle();
