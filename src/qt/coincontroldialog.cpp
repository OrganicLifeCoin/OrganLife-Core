...
CoinControlDialog::CoinControlDialog(QWidget* parent, bool _forDelegation) : ContainerDialog(parent, Qt::WindowSystemMenuHint | Qt::WindowTitleHint | Qt::WindowCloseButtonHint),
                                          ...
                                          const bool isChange)
{
    ...
    // if listMode or change => show OrganicLife address. In tree mode, address is not shown again for direct wallet address outputs
    if (!treeMode) {
