...
ColdStakingWidget::ColdStakingWidget(OrganicLifeGUI* parent) :
    PWidget(parent),
    ...
    isLoading(false)
{
    ...
    ui->rightContainer->setContentsMargins(0, 0, 0, 0);
    ui->rightContainer->setSpacing(6);
    ...
    ui->containerTitle->setAttribute(Qt::WA_StyledBackground, true);
    setCssProperty(ui->containerTitle, "screen-header-band");
    ...
    setCssProperty(ui->btnColdStaking, "screen-side-option", true);
    ...
    ui->btnColdStaking->layout()->setContentsMargins(0, 0, 0, 0);
    ...
    setCssProperty(ui->btnMyStakingAddresses, "screen-side-option", true);
    ...
    ui->horizontalLayout_6->setContentsMargins(16, 16, 16, 12);
    ui->horizontalLayout_6->setSpacing(10);
    ...
    ui->btnMyStakingAddresses->layout()->setContentsMargins(0, 0, 0, 0);
    ui->btnMyStakingAddresses->setRightIconClass("ic-arrow");

    // List Addresses
    setCssProperty(ui->listViewStakingAddress, "screen-side-card");
    ...
    ui->sortWidget->setAttribute(Qt::WA_StyledBackground, true);
    setCssProperty(ui->sortWidget, "screen-side-card");
...
void ColdStakingWidget::filterChanged(const QString& str)
{
    ...
    this->addressesFilter->setFilterRegularExpression(QRegularExpression(QRegularExpression::escape(str), QRegularExpression::CaseInsensitiveOption));
#else
