...
const QDateTime TransactionFilterProxy::MIN_DATE = GUIUtil::dateTimeFromTimeT(0);
// Last date that can be represented (far in the future)
const QDateTime TransactionFilterProxy::MAX_DATE = GUIUtil::dateTimeFromTimeT(0xFFFFFFFF);

void TransactionFilterProxy::refreshFilter()
{
...
bool TransactionFilterProxy::isOrphan(const int status, const int type)
{
    return ( (type == TransactionRecord::Generated || type == TransactionRecord::StakeMint ||
            type == TransactionRecord::MNReward || type == TransactionRecord::BudgetPayment)
