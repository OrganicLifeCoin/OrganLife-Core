...
{
    showHide(true);
    SettingsFaqWidget* dialog = new SettingsFaqWidget(this, nullptr);
...
#ifdef ENABLE_WALLET
void OrganicLifeGUI::setGovModel(GovernanceModel* model)
{
    govModel = model;
    if (governanceWidget) governanceWidget->setGovModel(model);
}
