...
ReceiveWidget::ReceiveWidget(OrganicLifeGUI* parent) :
    PWidget(parent),
    ui(new Ui::ReceiveWidget)
{
    ...
    ui->verticalLayout->removeItem(ui->verticalSpacer_8);
    ...
    // Options
    setCssProperty(ui->btnMyAddresses, "screen-side-option", true);
    ...
    ui->btnMyAddresses->layout()->setContentsMargins(0, 0, 0, 0);
    ui->btnMyAddresses->setRightIconClass("ic-arrow");

    setCssProperty(ui->btnRequest, "screen-side-option", true);
    ...
    ui->btnRequest->layout()->setContentsMargins(0, 0, 0, 0);
    ...
    // List Addresses
    setCssProperty(ui->listViewAddress, "screen-side-card");
