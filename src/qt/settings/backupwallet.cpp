...
#include "qt/settings/backupwallet.h"
#include "qt/settings/forms/ui_backupwallet.h"
...
SettingsBackupWallet::SettingsBackupWallet(OrganicLifeGUI* _window, QWidget *parent) :
