...
#include "qt/settings/displayoptionswidget.h"
#include "qt/settings/forms/ui_displayoptionswidget.h"
...
SettingsDisplayOptionsWidget::SettingsDisplayOptionsWidget(OrganicLifeGUI* _window, QWidget *parent) :
...
#endif
            ui->comboBoxLanguage->addItem(locale.nativeLanguageName() + QString(" - ") + territoryName + QString(" (") + langStr + QString(")"), QVariant(langStr));
        } else {
