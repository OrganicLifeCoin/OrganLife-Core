...
SettingsWidget::SettingsWidget(OrganicLifeGUI* parent) :
    PWidget(parent),
...
void SettingsWidget::loadWalletModel()
{
    ...
    this->settingsConsoleWidget->setWalletModel(this->walletModel);
}

void SettingsWidget::clearWalletModel()
{
    ...
    this->settingsConsoleWidget->clearWalletModel();
}
