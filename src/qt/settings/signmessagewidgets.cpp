...
#include "qt/settings/signmessagewidgets.h"
#include "qt/settings/forms/ui_signmessagewidgets.h"
...
SettingsSignMessageWidgets::SettingsSignMessageWidgets(OrganicLifeGUI* _window, QWidget *parent) :
...
void SettingsSignMessageWidgets::onSignMessageButtonSMClicked()
{
    ...
    if (!IsValidDestination(addr)) {
        ui->statusLabel_SM->setStyleSheet("QLabel { color: #F84444; }");
    ...
    ui->statusLabel_SM->setStyleSheet("QLabel { color: #9C4E1A; }");
...
void SettingsSignMessageWidgets::onVerifyMessage()
{
    ...
    if (fInvalid) {
        ...
        ui->signatureOut_SM->setStyleSheet("QLabel { color: #F84444; }");
