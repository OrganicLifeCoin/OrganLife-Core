...
#include "qt/settings/walletrepairwidget.h"
#include "qt/settings/forms/ui_walletrepairwidget.h"

#include "qtutils.h"

SettingsWalletRepairWidget::SettingsWalletRepairWidget(OrganicLifeGUI* _window, QWidget *parent) :
...
void SettingsWalletRepairWidget::buildParameterlist(QString arg)
{
    ...
    // Send command-line arguments to OrganicLifeGUI::handleRestart()
