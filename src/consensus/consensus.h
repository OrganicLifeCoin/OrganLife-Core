...
/** Larger max reorg depth for testnet to accommodate geographic latency with small node count **/
static const int DEFAULT_MAX_REORG_DEPTH_TESTNET = 1000;
/** Generous max reorg depth for mainnet stability (time-based: ~16.7 hours for 2-min blocks) **/
static const int DEFAULT_MAX_REORG_DEPTH_MAINNET = 500;
